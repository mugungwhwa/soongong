...
> **⚠️ 팔레트 v2.0 (2026-06-16, SOO-260616-01)**: 색 팔레트를 구 Ocean → **v2 Teal/Mint**로 교체(Mike 명시 승인). 아래 §1 의 스케일·hex는 모두 v2 값이며, 구 Ocean(`#2AB8D0`/`#1A8FAD`/`#0E5C82`)은 폐기. 섹션 라벨에 남은 "Ocean/o50~o900"은 히스토리 표기 — **변수 슬롯명이며 값은 v2**. 앵커 SSoT = 시안 UI EXAMPLE v1.0(`#A8DCCB`/`#7BC4AE`/`#4CAF88`/`#FFEBA3`/`#FFB4B4`/`#6BA6FF`/`#8E8E93`).
