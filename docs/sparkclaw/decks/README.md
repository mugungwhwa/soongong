...
| 산출물 | 파일 | 슬라이드 | 성격 |
|---|---|---|---|
| Deck A | `순공대장_사업소개서.pdf` | 19 | 메인 사업소개서 (정체성→문제→솔루션→콴다·포지셔닝→제품/플랫폼→**시장 4장: 망각곡선#5→듀오링고#13→한국TAM#14→공백·확장#15**→BM→트랙션→팀→비전) |
...
- **#15 공백+확장** — 콴다 누적 9,000만+/MAU ~800~980만/투자 $105M+(보조) → 리텐션 카테고리 공백(정황 근거). 글로벌 시험준비 CAGR ~7%(Technavio·변동, 절대치 단독 표기 금지).
