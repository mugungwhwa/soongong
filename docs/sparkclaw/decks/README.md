...
- **#15 경쟁 포지셔닝 맵(2x2)** — X: 막힘 해결↔까먹음 해결 / Y: 수동 소비↔습관·게이미피케이션. 좌하 군집 콴다(누적 1억+·MAU 500만+)·메가스터디·밀크티·뤼이드/산타 → 우상 빈 사분면 = 순공대장(참조점 듀오링고, 해외·어학 한정). 메시지: "풀어주거나·가르쳐주거나·맞춰주지만 '까먹지 않게+매일 하게'는 없다." 규모=공개자료·추정 범위, 콴다 계승 톤. ZEP/JEP Quiz는 Mike 확인 대기로 제외.
