...
- 캐릭터 = 승인 자산만: 히어로 `brand/main_concepting_.png`(Deck A 표지), 반신 마스코트 `mascot/main-half*.png`(표정 4종 누끼 — Deck B 표지=cheer, Deck A 클로징=기본). **`mascot/main-alpha.png`(왕관 듀공 전신)은 "안 쓰는 마스코트"로 deck 사용 금지**(SOO-84, Mike). 임의 마스코트·예전 캐릭터 생성 금지.
