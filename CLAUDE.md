...
| **v2.1** | **2026-06-20** | **§2 게임화 강도 행에 홈 게임성 상한 30%→50% 상향 명기 (SOO-90, Mike 결정). 활기 있게 한 단계 업 — 50% 한도 내 축하 모먼트·마스코트 모션·연출 OK, 다크/네온 남발은 여전히 §8 폐기. 정본 수치는 `게임성_기획_구조.md §9` 동기화, design-review 스킬 §2-3 표 동시 갱신.** |
